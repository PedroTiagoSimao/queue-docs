---
title: "How to Connect Integrations in the Google App"
sidebarTitle: "Connect"
description: "Step-by-step instructions to connect the Google app with calendars, Slack, Google Drive, Zapier, email, and other popular tools."
---
